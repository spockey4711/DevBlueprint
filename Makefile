...
SHELL_FILES := bin/devblueprint scripts/wt.sh scripts/protect-branches.sh scripts/scaffold-check.sh scripts/beginner-artifacts-check.sh scripts/docs-check.sh scripts/docs-freshness.sh scripts/repo-traffic.sh install.sh $(wildcard variants/*/setup.sh)
