# Backlog archive (P0 - P7)

Completed roadmap phases, moved here to keep the active [`backlog.md`](backlog.md) focused on
what is next. These tasks are all shipped; kept for reference and history. Task markers:
`- [ ]` todo, `- [x]` done, `- [~]` merged with a follow-up still pending.
